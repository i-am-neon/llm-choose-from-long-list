...
export async function generateSituation(): Promise<string> {
  const systemMessage =
    "Create a situation for an item to be chosen within an RPG fantasy world. Mention the setting and container (e.g. chest, closet, pot... get creative!). Output should be one sentence.";
