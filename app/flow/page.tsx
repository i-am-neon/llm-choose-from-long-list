...
export default function Example() {
  ...
  return (
    <div className="py-24 sm:py-32 max-w-4xl mx-auto">
      <div className="max-w-4xl">
        ...
        <p className="mt-6 text-balance text-xl/8">
          This is a step by step representation of the flow of the AI using the
          vector database to choose which item best suits the situation.
        </p>
      </div>
      <section className="mt-20 flex flex-col gap-8">
        ...
        {query && (
          <div>
            ...
            <p className="mt-2 text-base/7">
              Query the vector database to return the top five video game items
